...
class ContentService {
    ...
    def addCommonVariables(def process) {
        ...
        process.addToVariables(new Variable(idx: 5, dir: "", name: "nJumps", title: "Jumps", dataType: "int", width: 80, hidden: true))
        process.addToVariables(new Variable(idx: 6, dir: "", name: "processViolations", title: "Process violations", dataType: "int", allowBlank: true, hidden: true, width: 80))
